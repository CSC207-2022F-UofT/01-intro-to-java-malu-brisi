...
public class Basics {
    ...
    public static String split(String to_split) {
        ...
        String[] sepString = to_split.split(" "); // creates new array separating to_split words

        for (int j = 0; j < sepString.length; j++) { // for loop runs for all available indexes of sepString array
            ret.append(sepString[j].charAt(0)); // appending first letter of each string at index j
        }
